...
def dialog_start():
    return "Подойдя к человеку в сером, вы разглядываете его лицо: это уставшее лицо молодого человека с легкой порослью на щеках и давно не мытыми волосам, которые свисают из-под капюшона. \r\n Он поднимаете на вас затравленный взгляд. К-к-к-кто в-вы? П-п-первый раз вижу!"
...
def dialog_1():
	return "Ученик Ри: Д-да. Все в-в-верно. Но в-в-вот толь-к-ко лорда я не видел еще с прошлой среды. И все что знал уже рассказал страже. \r\n *Вы замечаете, как Он ежится и отводит взгляд*"
...
def dialog_2():
	return "Глаза парня округляются, он берет книгу трясущимся руками и поднимает на вас взгляд. \r\n Ученик Ри: Значит вы тоже поняли, что это как-то связано! Надеюсь вы не доложили об этом? *хватается руками за голову* \r\n Наш герой! Лорд-защитник, занимающийся некромантией!! Представляете какую тень это бросает на его имя??"
