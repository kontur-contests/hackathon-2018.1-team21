...
def ok():
    ...
    if where == 'По рукам':
        print('*Увесистый кошель падает на стол.* Глава гильдии мастер Торхилд – Чтож, мне необходимо приступить к обязанностям возложенным на меня в отсутствие лорда. Да помогут Вам Боги! Вы оглядываете приемную и замечаете две двери, помимо той которая привела вас сюда.')