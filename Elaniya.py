...
def dialog_answer_buttons_5():
	keyboard = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="Я хочу поговорить о пропаже вашего жениха. Скажите, леди, он не рассказывал вам что ни будь странное или пугающее о своих планах?")]])
	return keyboard
