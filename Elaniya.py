...
def dialog_answer_buttons_5():
	keyboard = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="Я хочу поговорить о пропаже вашего жениха. Вы последняя видели его, за день, того как его хватились.\r\n До меня доходят слухи, о том, что лорд странно вел себя последнее время.\r\nСкажите, леди, он не рассказывал вам что ни будь странное или пугающее о своих планах?")]])
	return keyboard
